...
//precondition: going to then get the coefficents, start with the coeffiecnts size
//postcondition: going to then return the coefficents terms numbers 
...
//precondition: going to get the evaluate, pass in an argu
//postcondition: going to then loop through the coefficients size, take the pow of the value we enter
...
//precondition: going to get the derivative
//postcondition: going to return the derivative, have to push back, index * the cofficient
...
//precondition: going to get the integral if found
...
//postcondition: going to then do three cases that lets me get one polynomial and multiple polynomials
...
//precondition: going to pass in the class obj
//postcondition: going to get the max between both objs, then add it
...
//precondition: going to pass in the class obj
//postcondition: going to get the max between both objs, then subtract it
...
//precondition: going to pass in the class object 
//postcondition: going to then return the multiplication, have to do the coefficent times the pow as well
...
//preconditon: going to pass in one argu 
//postcondition: going to for loop through the size (coefficeients) then push back the coefficients by index and multiply it
